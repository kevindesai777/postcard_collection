var json = [
    {
        "type": "FOTW",
        "values": ["Japan", "Slovenia", "Sweden", "Czech Republic ", "Switzerland ", "Netherlands", "United Kingdom", "Hungary", "United Arab Emirates", "Austria", "Taiwan", "Romania", "Spain", "Andorra", "Gibraltar", "Sri Lanka", "India", "Liechtenstein", "Northern Ireland", "Estonia", "Finland", "Australia", "European Union", "Indonesia", "Croatia", "Germany", "Hong Kong", "England", "China", "Canada", "Bulgaria", "Cambodia", "Malaysia", "Kosovo", "Albania", "Montenegro", "Italy", "Poland", "Ukraine", "Laos", "Azores", "Norway", "Bosnia", "Chile", "Cyprus", "Greece", "Netherlands", "Philippines", "Argentina", "South Korea", "French Guyana", "Aland Island", "ASEAN", "Turkey (Arranged)", "Cocos Island", "Thailand (Arranged)", "Costa Rica", "Ireland", "Dominican Republic (Arranged)", "Palau", "Portugal", "Azerbaijan", "USA", "Macau (Arranged)", "Iceland", "Belgium", "Latvia", "Kazakhstan", "Israel", "Benin", "Iran", "Ascension Island (Arranged)", "Falkland Island (Arranged)", "Nepal (Arranged)", "Serbia (Arranged)", "Slovakia", "Vietnam", "Uruguay", "Cuba", "Brazil", "Brunei", "Ivory Coast (Arranged)", "Rwanda", "Singapore", "France", "Luxembourg", "Suriname", "Russia (Arranged)", "Malta (Arranged)", "Guadeloupe", "Uzbekistan (Arranged)", "Papua New Guineu (Arranged)", "Seychelles (Arranged)", "Bangladesh (Arranged)", "Peru", "North Macedonia", "Wales (Arranged)", "Belarus (Arranged)", "Bahamas"]
    },
    {
        "type": "MOTW",
        "values": ["Austria", "Costa Rica", "Canada", "UK", "Hong Kong", "Italy", "Finland", "Norway", "Spain", "Malaysia", "Japan", "Germany", "Czech Republic", "Taiwan", "China (Arranged)", "England", "Croatia", "Thailand", "UAE", "Sovereign Military Order Of Malta", "Poland", "Ukraine", "Armenia", "Portgual (Arranged)", "Latvia", "Turkey (Arranged)", "St Pierre and Miquelon", "Singapore", "Malta", "India (Arranged)", "Nepal", "Maldives (Arranged)", "Philippines (Arranged)", "Switzerland", "Slovenia", "Peru", "Belarus (Arranged)", "Bahamas"]
